...
export interface ResumeFormActionsProps {
  state: BaseInterpretedLaunchState;
  service: BaseLaunchService;
  onClose(): void;
  isError: boolean;
}
/** Renders the Resume/Cancel buttons for a ResumeForm */
export const ResumeFormActions: React.FC<ResumeFormActionsProps> = ({
  state,
  service,
  onClose,
  isError,
