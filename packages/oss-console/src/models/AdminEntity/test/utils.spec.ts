...
import { adminApiUrl, createPaginationTransformer, encodeProtoPayload } from '../utils';

jest.mock('@clients/common/environment', () => ({
  env: jest.requireActual('@clients/common/environment').env,
}));
