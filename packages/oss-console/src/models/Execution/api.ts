...
} from '../AdminEntity/constants';
import { endpointPrefixes } from '../Common/constants';
import { Identifier, IdentifierScope, NameIdentifierScope } from '../Common/types';
...
export const listExecutions = async (scope: IdentifierScope, config?: RequestConfig) =>
  getAdminEntity(
    {
...
export const getExecution = async (id: WorkflowExecutionIdentifier, config?: RequestConfig) =>
...
export const createWorkflowExecution = (
  ...
  if (overwriteCache) {
    spec.overwriteCache = overwriteCache;
  }
...
export const listTaskExecutions = async (id: NodeExecutionIdentifier, config?: RequestConfig) =>
  getAdminEntity(
    {
...
export const getExecutionMetrics = (
  id: WorkflowExecutionIdentifier,
  config?: RequestConfig,
): Promise<WorkflowExecutionGetMetricsResponse> =>
  getAdminEntity<Admin.WorkflowExecutionGetMetricsResponse, WorkflowExecutionGetMetricsResponse>(
    {
