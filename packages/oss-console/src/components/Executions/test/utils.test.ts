...
describe('getWorkflowExecutionTimingMS', () => {
  ...
  it('should return undefined when terminal with no duration', () => {
    delete execution.closure.duration;
    expect(getWorkflowExecutionTimingMS(execution)).toBeUndefined();

    execution.closure.phase = WorkflowExecutionPhase.FAILED;
    expect(getWorkflowExecutionTimingMS(execution)).toBeUndefined();
  });

  it('should return undefined when no startedAt field is present', () => {
...
describe('getNodeExecutionTimingMS', () => {
  ...
  it('should return undefined when terminal with no duration', () => {
    delete execution.closure.duration;
    expect(getNodeExecutionTimingMS(execution)).toBeUndefined();
...
describe('getTaskExecutionTimingMS', () => {
  ...
  it('should return undefined when terminal with no duration', () => {
    delete execution.closure.duration;
    expect(getTaskExecutionTimingMS(execution)).toBeUndefined();
