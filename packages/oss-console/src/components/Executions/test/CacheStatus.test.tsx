...
import { cacheStatusMessages, viewSourceExecutionString } from '../constants';
...
describe('Executions > CacheStatus', () => {
  ...
  describe('check renders', () => {
    ...
    it('should render source execution link for cache hits', () => {
      ...
      expect(removeLeadingSlash(linkEl.getAttribute('href'))).toEqual(
        removeLeadingSlash(Routes.ExecutionDetails.makeUrl(mockWorkflowExecutionId)),
      );
    });
  });
