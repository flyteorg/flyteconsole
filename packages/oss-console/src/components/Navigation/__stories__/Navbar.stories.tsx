...
import { ExecutionContext } from '../../Executions/contexts';
import { ExecutionDetailsAppBarContent } from '../../Executions/ExecutionDetails/ExecutionDetailsAppBarContent';
...
WithColor.args = {
  ...
  items: [
    {
      title: 'Dashboard',
      url: '/projects/flytesnacks/executions?domain=development&duration=all',
    },
  ],
};
