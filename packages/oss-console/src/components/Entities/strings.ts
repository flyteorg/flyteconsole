...
const str = {
  ...
  launchPlan_status: 'Status',
  launchPlan_schedule: 'Schedule',
  launchPlan_lastExecution: 'Last Execution',
  launchPlan_nextPotentialExecution: 'Next Potential Execution',
  launchPlan_createdAt: 'Created At',
  launchPlan_scheduledVersion: 'Scheduled Version',
};
