...
import { LaunchRoles, AuthRoleTypes } from './types';
...
const RoleDescription = () => (
  <>
    <Typography variant="body2">
      Enter values for
      <NewTargetLink inline href={docLink}>
        &nbsp;Security Context&nbsp;
      </NewTargetLink>
...
export const LaunchRoleInputImpl = (props, ref) => {
  ...
  const getValue = () => {
    const authRole = {} as Admin.IAuthRole;
    const securityContext = { runAs: {} } as Core.SecurityContext;
