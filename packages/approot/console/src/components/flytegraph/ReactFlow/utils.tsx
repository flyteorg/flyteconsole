...
import { NodeExecutionPhase, TaskExecutionPhase } from '@flyteconsole/components';
...
) => string = (nodeExecutionStatus?: NodeExecutionPhase | TaskExecutionPhase): string => {
...
) => CSSProperties = (type: dTypes, nodeExecutionStatus?: NodeExecutionPhase): CSSProperties => {
