...
const sasWithMapValueTypeColumns: TestCaseList<Core.IStructuredDataset> =
  Object.keys(simple)
...
const sasWithCollectionTypeColumns: TestCaseList<Core.IStructuredDataset> =
  Object.keys(simple)
    .map((simpleTypeKey, index) => {
      const simpleType = simple[simpleTypeKey];
...
const sdsWithSimpleTypeColumns: TestCaseList<Core.IStructuredDataset> =
  Object.keys(simple)
    .map((simpleTypeKey, index) => {
