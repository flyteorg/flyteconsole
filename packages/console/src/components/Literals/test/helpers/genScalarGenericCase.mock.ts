...
const structValueTestCases: TestCaseList<Protobuf.IStruct> = {
  WITH_STRUCT_VALUE: {
    value: {
      fields: {
        test_struct_name: getIValue('structValue', {
          fields: {
            struct_string_val_copy: stringValueTestCases.WITH_STRING_VAL.value
              ?.fields?.test_field_name4 as Protobuf.IValue,
    ...
    expected: {
      result_var: {
        test_struct_name: {
          struct_string_val_copy: 'test val',
          struct_bool_val_copy: true,
        },
      },
    },
  },
...
const listValueTestCases: TestCaseList<Protobuf.IStruct> = {
  WITH_LIST_VALUE: {
    ...
    expected: {
      result_var: {
        test_list_name: [
          { struct_bool_val_copy: true, struct_string_val_copy: 'test val' },
        ],
      },
    },
  },
