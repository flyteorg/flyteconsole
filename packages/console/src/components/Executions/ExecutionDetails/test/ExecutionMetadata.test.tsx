...
import { Protobuf } from '@flyteoss/flyteidl';
...
import { removeTrailingSlash } from '@flyteoss/common';
...
describe('ExecutionMetadata', () => {
  ...
  it('shows reference execution if it exists', () => {
    ...
    expect(removeTrailingSlash(linkEl.getAttribute('href')!)).toEqual(
      removeTrailingSlash(Routes.ExecutionDetails.makeUrl(referenceExecution)),
    );
  });
