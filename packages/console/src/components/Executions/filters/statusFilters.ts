...
> = {
  queued: {
    label: 'Scheduled',
    value: 'queued',
    data: workflowExecutionPhaseConstants()[WorkflowExecutionPhase.QUEUED]
      .value,
  },
  running: {
    label: 'In Progress',
    value: 'running',
    data: workflowExecutionPhaseConstants()[WorkflowExecutionPhase.RUNNING]
      .value,
  },
  succeeded: {
    label: 'Successful',
    value: 'succeeded',
    data: workflowExecutionPhaseConstants()[WorkflowExecutionPhase.SUCCEEDED]
      .value,
  },
  failed: {
    label: 'Failed',
    value: 'failed',
    data: workflowExecutionPhaseConstants()[WorkflowExecutionPhase.FAILED]
      .value,
  },
  aborted: {
    label: 'Aborted',
    value: 'aborted',
    data: workflowExecutionPhaseConstants()[WorkflowExecutionPhase.ABORTED]
      .value,
  },
  unknown: {
    label: 'Unknown',
    value: 'unknown',
    data: workflowExecutionPhaseConstants()[WorkflowExecutionPhase.UNDEFINED]
      .value,
  },
};
