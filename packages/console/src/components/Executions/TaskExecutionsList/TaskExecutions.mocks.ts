import { Protobuf, Event } from '@flyteorg/flyteidl-types';
...
const getProtobufTimestampFromIsoTime = (
  isoDateTime: string,
): Protobuf.ITimestamp => {
...
const getProtobufDurationFromString = (
  durationSec: string,
): Protobuf.Duration => {
...
export const MockPythonTaskExecution: TaskExecution = {
  ...
  closure: {
    ...
    createdAt: getProtobufTimestampFromIsoTime(
      '2022-03-17T21:30:53.469624134Z',
    ),
    updatedAt: getProtobufTimestampFromIsoTime(
      '2022-03-17T21:31:04.011303736Z',
    ),
...
export const getMockMapTaskLogItem = (
  ...
  const retryString =
    retryAttempt && retryAttempt > 0 ? `-${retryAttempt}` : '';
  return {
...
export const MockMapTaskExecution: TaskExecution = {
  ...
  closure: {
    ...
    createdAt: getProtobufTimestampFromIsoTime(
      '2022-03-30T19:31:09.487343693Z',
    ),
    updatedAt: getProtobufTimestampFromIsoTime(
      '2022-03-30T19:34:19.789727340Z',
    ),
