    ...
    <section>
      <header className={styles.sectionHeader}>
        ...
        <Typography variant="body2">
          Overrides the interruptible flag of a workflow for a single execution,
          allowing it to be forced on or off. If no value was selected, the
          workflow's default will be used.
        </Typography>
      </header>
