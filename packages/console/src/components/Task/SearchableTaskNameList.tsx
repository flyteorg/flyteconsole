...
const SimpleTaskActions: React.FC<SimpleTaskActionsProps> = ({
  item,
  setShowItem,
}) => {
  const styles = useStyles();
  ...
  const mutation = useMutation(
    (newState: NamedEntityState) => updateTaskState(id, newState),
    {
  ...
  return (
    <div ref={inViewRef} className={listStyles.searchResult}>
      <div className={listStyles.itemName}>
        ...
        {!!inView && (
          <TaskInterface setShowItem={setShowItem} taskName={entityName} />
        )}
