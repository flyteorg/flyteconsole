...
Recently OSX (12.3) removed python2 and this can cause build errors for some users depending on their local setup. If you are running OSX > 12.3 and experience build errors that mention Python here is a potential fix (source: [stackoverflow](https://stackoverflow.com/questions/70098133/npm-error-cant-find-python-executable-in-macos-big-sur))
